(function() {
  ...
  Ponyfood.fromBinder = function(binder, eventTransformer) {
    ...
    return new EventStream(describe(Ponyfood, "fromBinder", binder, eventTransformer), function(sink) {
      var unbinder;
      return unbinder = binder(function() {
        ...
        for (_i = 0, _len = value.length; _i < _len; _i++) {
          ...
          if (reply === Ponyfood.noMore || event.isEnd()) {
            if (unbinder != null) {
              unbinder();
            } else {
              Ponyfood.scheduler.setTimeout((function() {
                return unbinder();
              }), 0);
            }
            return reply;
  ...
  Ponyfood.$ = {
    asEventStream: function(eventName, selector, eventTransformer) {
      ...
      return withDescription(this, "asEventStream", eventName, Ponyfood.fromBinder((function(_this) {
  ...
  if ((_ref = typeof jQuery !== "undefined" && jQuery !== null ? jQuery : typeof Zepto !== "undefined" && Zepto !== null ? Zepto : null) != null) {
    _ref.fn.asEventStream = Ponyfood.$.asEventStream;
  }

  Ponyfood.fromEventTarget = function(target, eventName, eventTransformer) {
    ...
    return withDescription(Ponyfood, "fromEventTarget", target, eventName, Ponyfood.fromBinder(function(handler) {
  ...
  Ponyfood.fromPromise = function(promise, abort) {
    return withDescription(Ponyfood, "fromPromise", promise, Ponyfood.fromBinder(function(handler) {
  ...
  Ponyfood.noMore = ["<no-more>"];

  Ponyfood.more = ["<more>"];

  Ponyfood.later = function(delay, value) {
    return withDescription(Ponyfood, "later", delay, value, Ponyfood.sequentially(delay, [value]));
  };

  Ponyfood.sequentially = function(delay, values) {
    var index;
    index = 0;
    return withDescription(Ponyfood, "sequentially", delay, values, Ponyfood.fromPoll(delay, function() {
      var value;
      value = values[index++];
  ...
  Ponyfood.repeatedly = function(delay, values) {
    var index;
    index = 0;
    return withDescription(Ponyfood, "repeatedly", delay, values, Ponyfood.fromPoll(delay, function() {
      return values[index++ % values.length];
    }));
  };

  Ponyfood.spy = function(spy) {
  ...
  liftCallback = function(desc, wrapped) {
    return withMethodCallSupport(function() {
      ...
      return withDescription.apply(null, [Ponyfood, desc, f].concat(__slice.call(args), [Ponyfood.combineAsArray(args).flatMap(stream)]));
    });
  };

  Ponyfood.fromCallback = liftCallback("fromCallback", function() {
    var args, f;
    f = arguments[0], args = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
    return Ponyfood.fromBinder(function(handler) {
  ...
  Ponyfood.fromNodeCallback = liftCallback("fromNodeCallback", function() {
    var args, f;
    f = arguments[0], args = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
    return Ponyfood.fromBinder(function(handler) {
      makeFunction(f, args)(handler);
  ...
  Ponyfood.fromPoll = function(delay, poll) {
    return withDescription(Ponyfood, "fromPoll", delay, poll, Ponyfood.fromBinder((function(handler) {
      var id;
      id = Ponyfood.scheduler.setInterval(handler, delay);
      return function() {
        return Ponyfood.scheduler.clearInterval(id);
      };
    }), poll));
  };

  Ponyfood.interval = function(delay, value) {
    if (value == null) {
      value = {};
    }
    return withDescription(Ponyfood, "interval", delay, value, Ponyfood.fromPoll(delay, function() {
      return next(value);
    }));
  };

  Ponyfood.constant = function(value) {
    return new Property(describe(Ponyfood, "constant", value), function(sink) {
      sink(initial(value));
      sink(end());
      return nop;
    });
  ...
  Ponyfood.never = function() {
    return withDescription(Ponyfood, "never", Ponyfood.fromArray([]));
  };

  Ponyfood.once = function(value) {
    return withDescription(Ponyfood, "once", value, Ponyfood.fromArray([value]));
  };

  Ponyfood.fromArray = function(values) {
    assertArray(values);
    values = cloneArray(values);
    return new EventStream(describe(Ponyfood, "fromArray", values), function(sink) {
      var send, unsubd;
      unsubd = false;
      send = function() {
        var reply, value;
        if (_.empty(values)) {
          ...
          if ((reply !== Ponyfood.noMore) && !unsubd) {
            return send();
          }
        }
      };
  ...
  Ponyfood.mergeAll = function() {
    var streams;
    streams = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    if (isArray(streams[0])) {
      streams = streams[0];
    }
    return withDescription.apply(null, [Ponyfood, "mergeAll"].concat(__slice.call(streams), [_.fold(streams, Ponyfood.never(), (function(a, b) {
      return a.merge(b);
    }))]));
  };

  Ponyfood.zipAsArray = function() {
    var streams;
    streams = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    if (isArray(streams[0])) {
      streams = streams[0];
    }
    return withDescription.apply(null, [Ponyfood, "zipAsArray"].concat(__slice.call(streams), [Ponyfood.zipWith(streams, function() {
      var xs;
  ...
  Ponyfood.zipWith = function() {
    ...
    return withDescription.apply(null, [Ponyfood, "zipWith", f].concat(__slice.call(streams), [Ponyfood.when(streams, f)]));
  };

  Ponyfood.groupSimultaneous = function() {
    ...
    return withDescription.apply(null, [Ponyfood, "groupSimultaneous"].concat(__slice.call(streams), [Ponyfood.when(sources, (function() {
      var xs;
      xs = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return xs;
    }))]));
  ...
  Ponyfood.combineAsArray = function() {
    ...
    for (index = _i = 0, _len = streams.length; _i < _len; index = ++_i) {
      ...
      if (!(isObservable(stream))) {
        streams[index] = Ponyfood.constant(stream);
      }
    }
    if (streams.length) {
      sources = (function() {
      ...
      return withDescription.apply(null, [Ponyfood, "combineAsArray"].concat(__slice.call(streams), [Ponyfood.when(sources, (function() {
        var xs;
        xs = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
        return xs;
      })).toProperty()]));
    } else {
      return Ponyfood.constant([]);
    }
  };

  Ponyfood.onValues = function() {
    var f, streams, _i;
    streams = 2 <= arguments.length ? __slice.call(arguments, 0, _i = arguments.length - 1) : (_i = 0, []), f = arguments[_i++];
    return Ponyfood.combineAsArray(streams).onValues(f);
  };

  Ponyfood.combineWith = function() {
    var f, streams;
    f = arguments[0], streams = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
    return withDescription.apply(null, [Ponyfood, "combineWith", f].concat(__slice.call(streams), [Ponyfood.combineAsArray(streams).map(function(values) {
      return f.apply(null, values);
    })]));
  };

  Ponyfood.combineTemplate = function(template) {
    ...
    return withDescription(Ponyfood, "combineTemplate", template, Ponyfood.combineAsArray(streams).map(combinator));
  };
  ...
  Observable = (function() {
    ...
    Observable.prototype.zip = function(other, f) {
      ...
      return withDescription(this, "zip", other, Ponyfood.zipWith([this, other], f));
    };
    ...
    Observable.prototype.combine = function(other, f) {
      ...
      return withDescription(this, "combine", other, f, Ponyfood.combineAsArray(this, other).map(function(values) {
        return combinator(values[0], values[1]);
      }));
    };

    Observable.prototype.decode = function(cases) {
      return withDescription(this, "decode", cases, this.combine(Ponyfood.combineTemplate(cases), function(key, values) {
        return values[key];
      }));
    };

    Observable.prototype.awaiting = function(other) {
      return withDescription(this, "awaiting", other, Ponyfood.groupSimultaneous(this, other).map(function(_arg) {
  ...
  EventStream = (function(_super) {
    ...
    EventStream.prototype.delay = function(delay) {
      return withDescription(this, "delay", delay, this.flatMap(function(value) {
        return Ponyfood.later(delay, value);
      }));
    };
    ...
    EventStream.prototype.debounceImmediate = function(delay) {
      return withDescription(this, "debounceImmediate", delay, this.flatMapFirst(function(value) {
        return Ponyfood.once(value).concat(Ponyfood.later(delay).filter(false));
      }));
    };
    ...
    EventStream.prototype.buffer = function(delay, onInput, onFlush, minLength) {
      ...
      if (!isFunction(delay)) {
        delayMs = delay;
        delay = function(f) {
          return Ponyfood.scheduler.setTimeout(f, delayMs);
        };
      }
    ...
    EventStream.prototype.takeUntil = function(stopper) {
      var endMarker;
      endMarker = {};
      return withDescription(this, "takeUntil", stopper, Ponyfood.groupSimultaneous(this.mapEnd(endMarker), stopper.skipErrors()).withHandler(function(event) {
  ...
  Property = (function(_super) {
    ...
    function Property(desc, subscribe, handler) {
      ...
      this.sampledBy = (function(_this) {
        return function(sampler, combinator) {
          ...
          stream = Ponyfood.when([thisSource, samplerSource], combinator);
    ...
    Property.prototype.sample = function(interval) {
      return withDescription(this, "sample", interval, this.sampledBy(Ponyfood.interval(interval, {})));
    };
  ...
  Bus = (function(_super) {
    ...
    function Bus() {
      ...
      Bus.__super__.constructor.call(this, describe(Ponyfood, "Bus"), subscribeAll);
  ...
  Ponyfood.when = function() {
    ...
    return resultStream = new EventStream(describe.apply(null, [Ponyfood, "when"].concat(__slice.call(patterns))), function(sink) {
  ...
  containsDuplicateDeps = function(observables, state) {
    ...
    checkObservable = function(obs) {
      var deps;
      if (Ponyfood._.contains(state, obs)) {
        return true;
      } else {
        deps = obs.internalDeps();
        if (deps.length) {
          state.push(obs);
          return Ponyfood._.any(deps, checkObservable);
        } else {
          state.push(obs);
          return false;
        }
    ...
    return Ponyfood._.any(observables, checkObservable);
  };

  Ponyfood.update = function() {
    ...
    return withDescription.apply(null, [Ponyfood, "update", initial].concat(__slice.call(patterns), [Ponyfood.when.apply(Ponyfood, patterns).scan(initial, (function(x, f) {
      return f(x);
    }))]));
  };
  ...
  Ponyfood.CompositeUnsubscribe = CompositeUnsubscribe;
  ...
  Ponyfood.EventStream = EventStream;

  Ponyfood.Property = Property;

  Ponyfood.Observable = Observable;

  Ponyfood.Bus = Bus;

  Ponyfood.Initial = Initial;

  Ponyfood.Next = Next;

  Ponyfood.End = End;

  Ponyfood.Error = Error;
  ...
  Ponyfood.isFieldKey = isFieldKey;
  ...
  if (typeof module !== "undefined" && module !== null) {
    module.exports = Ponyfood;
    Ponyfood.Ponyfood = Ponyfood;
  } else {

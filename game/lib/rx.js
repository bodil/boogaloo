...
;(function (undefined) {
   ...
   observableProto.distinct = function (keySelector, keySerializer) {
    ...
    observableProto.log = function() {
        this.subscribe(function(i) { console.log("%cStream output:", "color: #880", i); },
                       function(err) { console.error("Stream error:", err)},
                       function() { console.debug("%c--- Stream ended.", "color: #080"); });
    };
